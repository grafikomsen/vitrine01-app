...
@section('main')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-5 border-bottom">
        <h2 class="fs-2 fw-bold">Créer le blog</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-secondary rounded-1">
                        ...
                        <form method="POST" name="createblogForm" id="createblogForm">
                            <div class="card-body">

                                <div class="form-group mb-3">
                                    <label for="name">Nom du blog</label>
                                    <input type="text" name="name" id="name" class="form-control rounded-1" placeholder="Enter le nom du blog">
    ...
    <script>
        ...
        $('#createblogForm').submit(function(event){
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: $('#createblogForm').serializeArray(),
