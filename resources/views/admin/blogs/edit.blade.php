                        ...
                        <form method="POST" name="editBlogForm" id="editBlogForm">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" id="description" rows="6" class="form-control rounded-1">{{ $blog->description }}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="short_desc" id="short_desc" class="form-control rounded-1" cols="30" rows="7">{{ $blog->short_desc }}</textarea>
                                        </div>
                                    </div>
                                </div>
