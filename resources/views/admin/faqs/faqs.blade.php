...
@section('main')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2 class="fs-2 fw-bold">Liste des faqs</h2>
                ...
                <div class="col-12">
                   <div class="card rounded-1">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('admin.faqs.create') }}" class="btn btn-primary btn-sm shadow-sm rounded-1 border-0">
                                <i class="fas fa-plus"></i> &nbsp;Creer un faq
                            </a>
                        </div>
                                ...
                                <tbody>
                                    @if ($faqs->isNotEmpty())
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.faqs.edit',$faq->id) }}" class="btn btn-sm bg-primary rounded-1">
                                                    <i class="fa fa-edit text-white"></i>
                                                </a>
                                                <a href="javascript:void(0);" onclick="deleteFaq({{ $faq->id }})" class="btn btn-sm btn-danger rounded-1">
