...
@section('main')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-5 border-bottom">
        <h2 class="fs-2 fw-bold">Créer la page</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-secondary rounded-1">
                        ...
                        <form method="POST" name="createPageForm" id="createPageForm">
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    <label for="name">Nom de la page</label>
                                    <input type="text" name="name" id="name" class="form-control rounded-1" placeholder="Enter le nom de la page">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="url" id="url" class="form-control rounded-1" placeholder="Enter l'url de la page">
                                            <p class="error name-error text-danger"></p>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $('#createPageForm').submit(function(event){
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: $('#createPageForm').serializeArray(),
