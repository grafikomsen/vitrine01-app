...
@section('main')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2 class="fs-2 fw-bold">Liste des services</h2>
                ...
                <div class="col-12">
                   <div class="card rounded-1">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('admin.services.create') }}" class="btn btn-primary btn-sm shadow-sm rounded-1 border-0">
                            ...
                            <table class="table table-hover text-nowrap table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="100">Image du service</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (!empty($service->image))
                                                    <img class="img-thumbnail" src="{{ asset('uploads/services/'.$service->image) }}" width="50" alt="{{ $service->name }}">
                                                @else
                                            ...
                                            <td>
                                                <a href="{{ route('admin.services.edit',$service->id) }}" class="btn btn-sm bg-primary rounded-1">
                                                    <i class="fa fa-edit text-white"></i>
                                                </a>
                                                <a href="javascript:void(0);" onclick="deleteService({{ $service->id }})" class="btn btn-sm btn-danger rounded-1">
