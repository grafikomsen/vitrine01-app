...
@section('main')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-5 border-bottom">
        <h2 class="fs-2 fw-bold">Créer le Team</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-secondary rounded-1">
                        ...
                        <form method="POST" name="createTeamForm" id="createTeamForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <label for="name">Nom du team</label>
                                        <input type="text" name="name" id="name" class="form-control rounded-1" placeholder="Enter le nom du team">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="designation" id="designation" class="form-control rounded-1" cols="30" rows="7"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" name="url_fb" id="url_fb" class="form-control rounded-1" placeholder="Facebook">
                                        <p class="error name-error text-danger"></p>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label for="url_ins">Instagram</label>
                                        <input type="text" name="url_ins" id="url_ins" class="form-control rounded-1" placeholder="Instagram">
                                        <p class="error name-error text-danger"></p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" name="url_tw" id="url_tw" class="form-control rounded-1" placeholder="Twitter">
                                        <p class="error name-error text-danger"></p>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label for="url_in">Linkedin</label>
                                        <input type="text" name="url_in" id="url_in" class="form-control rounded-1" placeholder="Linkedin">
                                        <p class="error name-error text-danger"></p>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $('#createTeamForm').submit(function(event){
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: $('#createTeamForm').serializeArray(),
